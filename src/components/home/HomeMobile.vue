...
const trainingBg             = _B + 'backgrounds/homepage_bg.png'
import codexIcon              from '../../assets/ui/codex.png'
const leatherworkingIcon     = _B + 'ui/leatherworking_icon.png'
const tailoringIcon          = _B + 'ui/tailoring_icon.png'
const woodworkingIcon        = _B + 'ui/woodworking_icon.png'
const fusionWorkshopIcon     = _B + 'ui/fusion_worshop_icon.png'
const weaponForgeIcon        = _B + 'ui/weaponsmith_icon.png'
