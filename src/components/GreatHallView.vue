...
const frameCaelwyn      = _B + 'ui/caelwyn_thin_border_transparent_full.png'
const frameMordaine     = _B + 'ui/mordaine_border_195x260_transparent.png'
const frameAldric       = _B + 'ui/aldric_red_border_195x260_transparent.png'
import frameValdris      from '../assets/ui/valdris_border_195x260_transparent.png'
const _parchmentBg      = _B + 'ui/background_parchment.png'
