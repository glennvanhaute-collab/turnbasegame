...
const _dungeonEasy01Bg        = _B + 'dungeons/dungeon_easy_01.png'
const _dungeonEasyGoblins      = _B + 'dungeons/dungeon_easy_goblin_warrens.png'
const _dungeonEasySwamp        = _B + 'dungeons/easy_desolate_swamp.png'
const _dungeonEasyCrypt        = _B + 'dungeons/easy_undead_crypt.png'
const _dungeonIntermediate01   = _B + 'dungeons/dungeon_intermediate_01.png'
const _dungeonIntermediateAsh  = _B + 'dungeons/dungeon_intermediate_ashveil_mine.png'
const _dungeonIntermediateThorn = _B + 'dungeons/dungeon_intermediate_thornwood_depths.png'
const _dungeonIntermediateLair = _B + 'dungeons/intermediate_forgotten lair.png'
const _dungeonHard01           = _B + 'dungeons/dungeon_hard_01.png'
const _dungeonHard02           = _B + 'dungeons/dungeon_hard_02.png'
const _dungeonHardSpire        = _B + 'dungeons/dungeon_hard_dread_spire.png'
const _dungeonHardThornhaven   = _B + 'dungeons/dungeon_hard_thornhaven_ruins.png'
const _dungeonHardVampire      = _B + 'dungeons/hard_vampire_castle.png'
const _dungeonNightmare01      = _B + 'dungeons/dungeon_nightmare_01.png'
const _dungeonNightmareBarrow  = _B + 'dungeons/dungeon_nightmare_barrow_kings_tomb.png'
const _dungeonNightmareCrypts  = _B + 'dungeons/dungeon_nightmare_wailing_crypts.png'
const _tavernBg                = _B + 'dungeons/tavern.png'
const _blessedGroveBg          = _B + 'dungeons/blessed_grove.png'
const _ancientForgeBg          = _B + 'dungeons/ancient_forge.png'
const _ashenForgeBg            = _B + 'dungeons/ashen_forge.png'
const elvenForgeBg   = _B + 'forges/elven_forge.png'
const goblinForgeBg  = _B + 'forges/goblin_forge.png'
const dwarvenForgeBg = _B + 'forges/dwarven_forge.png'
...
.node-card.node-blessed::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(to bottom, rgba(4,8,18,0.30) 0%, rgba(4,8,18,0.72) 38%, rgba(4,8,18,0.82) 62%, rgba(4,8,18,0.95) 100%);
  pointer-events: none;
  z-index: 0;
  border-radius: 10px;
}
