...
import { ICONS, SHEET_COLS, SHEET_1_ROWS, SHEET_2_ROWS, SHEET_BS_COLS, SHEET_BS_ROWS, SHEET_LW_COLS, SHEET_LW_ROWS, SHEET_TW_COLS, SHEET_TW_ROWS, SHEET_MATS_COLS, SHEET_MATS_ROWS } from '../../game/data/spritesheet.js'
...
const SHEET_ROWS = { 1: SHEET_1_ROWS, 2: SHEET_2_ROWS, bs: SHEET_BS_ROWS, lw: SHEET_LW_ROWS, tw: SHEET_TW_ROWS, mats: SHEET_MATS_ROWS }
const SHEET_URLS = { 1: sheet1Url,    2: sheet2Url,    bs: sheetBsUrl,    lw: sheetLwUrl,    tw: sheetTwUrl,    mats: sheetMatsUrl    }
const SHEET_COLS_MAP = { 1: SHEET_COLS, 2: SHEET_COLS, bs: SHEET_BS_COLS, lw: SHEET_LW_COLS, tw: SHEET_TW_COLS, mats: SHEET_MATS_COLS }
