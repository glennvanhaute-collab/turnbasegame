        ...
        <aside class="item-list-panel">
          ...
          <div class="panel-body">
            ...
            <div class="item-list-scroll">
              ...
              >
                <GameIcon :icon="item.image ?? tierSlotIcon(item.tier, item.slot, item.craftDiscipline)" :size="14" class="ilb-icon" />
        ...
        <main class="upgrade-workspace">
          ...
          <template v-else>
            ...
            <div class="item-showcase" :class="{ maxed: artisanItem.stars >= (TIER_MAX_STARS[artisanItem.tier] ?? 10) }" :style="{ '--tier-color': artisanTierColor, '--rarity-color': artisanCapColor }">
              ...
              <GameIcon v-else :icon="artisanItem.image ?? tierSlotIcon(artisanItem.tier, artisanItem.slot, artisanItem.craftDiscipline)" :size="64" class="showcase-slot-icon" />
              <div class="stars-row">
                <span
...
const _fvB = import.meta.env.BASE_URL
const itemFrameImg    = _fvB + 'gear/frames/item_frame.png'
const elvenBorderImg  = _fvB + 'gear/frames/elven_border.png'
const dwarvenFrameImg = _fvB + 'gear/frames/dwarven_frame.png'
const goblinFrameImg  = _fvB + 'gear/frames/goblin_frame.png'
const elvenSwordImg   = _fvB + 'gear/elven/sword.png'
const elvenSpearImg   = _fvB + 'gear/elven/spear.png'
const elvenShieldImg  = _fvB + 'gear/elven/shield.png'
const elvenHelmImg    = _fvB + 'gear/elven/helm.png'
const elvenChestImg   = _fvB + 'gear/elven/chest.png'
const elvenPlateImg   = _fvB + 'gear/elven/platelegs.png'
const elvenGlovesImg  = _fvB + 'gear/elven/gloves.png'
