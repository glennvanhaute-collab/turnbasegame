    ...
    tiers: [
      {
        ...
        recipes: [
          ...
          { id: 'arcane_helm_steel',   name: 'Spellforged Helm',  slot: 'head',     tier: 'steel',     barCost: 3, barName: 'Steel Bars',     reqLevel: 5,  baseStats: { def: 55,  hp: 500 } },
          ...
          { id: 'arcane_boots_steel',  name: 'Runewalker Boots',  slot: 'boots',    tier: 'steel',     barCost: 3, barName: 'Steel Bars',     reqLevel: 5,  baseStats: { spd: 10, def: 40 } },
          { id: 'arcane_gloves_steel', name: 'Spellguard Gauntlets', slot: 'gloves', tier: 'steel',   barCost: 3, barName: 'Steel Bars',     reqLevel: 5,  baseStats: { atk: 60,  atkPct: 0.04 } },
        ],
      },
      {
        id: 'mithril', name: 'Mithril', color: '#5bacd4',
        recipes: [
          { id: 'arcane_chest_mithril',  name: 'Void-Forged Plate',   slot: 'chest',  tier: 'mithril', barCost: 5, barName: 'Mithril Bars', reqLevel: 12, baseStats: { def: 280, hp: 3200, atkPct: 0.10 } },
          { id: 'arcane_helm_mithril',   name: 'Void-Forged Sallet',  slot: 'head',   tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { def: 160, hp: 2000 } },
          { id: 'arcane_legs_mithril',   name: 'Starbound Cuisses',   slot: 'legs',   tier: 'mithril', barCost: 4, barName: 'Mithril Bars', reqLevel: 12, baseStats: { def: 220, hp: 2600, spd: 16 } },
          { id: 'arcane_boots_mithril',  name: 'Voidstep Sabatons',   slot: 'boots',  tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { spd: 20, def: 130 } },
          { id: 'arcane_gloves_mithril', name: 'Runecaster Gauntlets',slot: 'gloves', tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { atk: 200, atkPct: 0.09 } },
        ],
      },
      {
        ...
        recipes: [
          ...
          { id: 'arcane_legs_moon',   name: 'Eclipse Cuisses',   slot: 'legs',   tier: 'moonsilver', barCost: 4, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { def: 340, hp: 4600, spd: 24 } },
          { id: 'arcane_boots_moon',  name: 'Runewalk Sabatons', slot: 'boots',  tier: 'moonsilver', barCost: 3, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { spd: 28, def: 200 } },
          { id: 'arcane_gloves_moon', name: 'Eclipse Gauntlets', slot: 'gloves', tier: 'moonsilver', barCost: 3, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { atk: 320, atkPct: 0.14 } },
        ],
      },
    ],
  },
    ...
    tiers: [
      {
        ...
        recipes: [
          ...
          { id: 'shadow_legs_steel',   name: 'Phantom Chaps',       slot: 'legs',   tier: 'steel',     barCost: 4, barName: 'Steel Bars',     reqLevel: 5,  baseStats: { spd: 10, atk: 55 } },
          { id: 'shadow_boots_steel',  name: 'Whisper Treads',      slot: 'boots',  tier: 'steel',     barCost: 3, barName: 'Steel Bars',     reqLevel: 5,  baseStats: { spd: 14, critRate: 0.03 } },
          { id: 'shadow_gloves_steel', name: 'Veilbound Wraps',     slot: 'gloves', tier: 'steel',     barCost: 3, barName: 'Steel Bars',     reqLevel: 5,  baseStats: { atk: 65, critRate: 0.04 } },
        ],
      },
      {
        id: 'mithril', name: 'Mithril', color: '#5bacd4',
        recipes: [
          { id: 'shadow_chest_mithril',  name: 'Phantom Wrap',         slot: 'chest',  tier: 'mithril', barCost: 4, barName: 'Mithril Bars', reqLevel: 12, baseStats: { spd: 22, critRate: 0.07, hp: 2200 } },
          { id: 'shadow_helm_mithril',   name: 'Phantom Veil',          slot: 'head',   tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { spd: 16, critRate: 0.06 } },
          { id: 'shadow_legs_mithril',   name: 'Spectral Chaps',        slot: 'legs',   tier: 'mithril', barCost: 4, barName: 'Mithril Bars', reqLevel: 12, baseStats: { spd: 18, atk: 160 } },
          { id: 'shadow_boots_mithril',  name: 'Ghoststep Treads',      slot: 'boots',  tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { spd: 26, critRate: 0.06 } },
          { id: 'shadow_gloves_mithril', name: 'Voidstitch Wraps',      slot: 'gloves', tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { atk: 200, critRate: 0.07 } },
        ],
      },
      {
        id: 'moonsilver', name: 'Moonsilver', color: '#99ccff',
        recipes: [
          ...
          { id: 'shadow_legs_moon',   name: 'Starphase Chaps',  slot: 'legs',   tier: 'moonsilver', barCost: 4, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { spd: 28, atk: 260 } },
          { id: 'shadow_boots_moon',  name: 'Eclipse Treads',   slot: 'boots',  tier: 'moonsilver', barCost: 3, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { spd: 36, critRate: 0.09 } },
          { id: 'shadow_gloves_moon', name: 'Moonlace Wraps',   slot: 'gloves', tier: 'moonsilver', barCost: 3, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { atk: 320, critRate: 0.10 } },
        ],
      },
    ],
  },
    ...
    tiers: [
      ...
      },
      {
        ...
        recipes: [
          ...
          { id: 'tannery_boots_mithril',  name: 'Predator Treads',     slot: 'boots',  tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { spd: 22, def: 120 } },
          { id: 'tannery_gloves_mithril', name: 'Ironveil Gauntlets',  slot: 'gloves', tier: 'mithril', barCost: 3, barName: 'Mithril Bars', reqLevel: 12, baseStats: { atk: 175, def: 130 } },
        ],
      },
      {
        id: 'moonsilver', name: 'Moonsilver', color: '#99ccff',
        recipes: [
          ...
          { id: 'tannery_boots_moon',  name: 'Moonprowl Treads',  slot: 'boots',  tier: 'moonsilver', barCost: 3, barName: 'Moonsilver Bars', reqLevel: 18, baseStats: { spd: 32, def: 185 } },
