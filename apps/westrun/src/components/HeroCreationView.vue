...
const houseAldricImg   = _B + 'lore/house_aldric.png'
const houseValdrisImg  = _B + 'lore/house_valdris.png'
const houseCaelwynImg  = _B + 'lore/house_caelwyn.png'
const houseMordaineImg = _B + 'lore/house_mordaine.png'
